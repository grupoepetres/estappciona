...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { direccion: @parking.direccion, distrito: @parking.distrito, nombre: @parking.nombre, precioxhora: @parking.precioxhora, ubicacion: @parking.ubicacion } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { direccion: @parking.direccion, distrito: @parking.distrito, nombre: @parking.nombre, precioxhora: @parking.precioxhora, ubicacion: @parking.ubicacion } }
